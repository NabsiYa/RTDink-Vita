...
//	pProvider->CacheShowMoreApps();
	...
	*/
	...
	if (GetEmulatedPlatformID() == PLATFORM_ID_WINDOWS || GetEmulatedPlatformID() == PLATFORM_ID_OSX || GetEmulatedPlatformID() == PLATFORM_ID_HTML5 || hasPSTV == true)
	{
...
if (GetEmulatedPlatformID() == PLATFORM_ID_IOS || GetEmulatedPlatformID() == PLATFORM_ID_HTML5 || GetEmulatedPlatformID() == PLATFORM_ID_PSVITA )
{
	...
	App::OnMemoryWarning(); //test idk whats going to happen..
